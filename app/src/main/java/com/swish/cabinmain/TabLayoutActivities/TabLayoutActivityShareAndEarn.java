...
public class TabLayoutActivityShareAndEarn extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter.addFragment(new FragmentShareAndEarnTab1(), "INVITE FRIENDS");
        adapter.addFragment(new FragmentShareAndEarnTab2(), "CREDITS EARNED");
